-- noqa: disable=ST03,RF01,RF02,LT02,PRS
{# sqlfluff cannot fully parse this model: dbt templater does not resolve CTE aliases through full outer joins. #}
...
joined as (
    ...
    from prev as p
    full outer join curr as c using (source_id)
)
